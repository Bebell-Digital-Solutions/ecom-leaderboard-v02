...
// It's included here to make app.js self-sufficient for the dashboard.
class DataStore {
    constructor() {
...
function handleRegister(event) {
    ...
    const newStore = dataStore.addStore({ name: storeName, storeId, email, password, url });
...
function testConnection() {
    ...
    setTimeout(() => {
        // In a real app, this would ping an endpoint. Here, we check if the tracking script has stored any data.
